...
function initDB() {
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS \`visitas_autoridades\` (
      \`id\`              INTEGER PRIMARY KEY AUTOINCREMENT,
      \`nombre\`          TEXT NOT NULL,
      \`cargo\`           TEXT NOT NULL,
      ...
      \`agenda\`          TEXT,
      \`acompanantes\`    TEXT,
      \`seremiAnfitrion\` TEXT,
      \`objetivos\`       TEXT,
      \`resultados\`      TEXT,
      \`impactoMedios\`   TEXT,
      \`creadoPor\`       TEXT,
      \`creadoEn\`        TEXT,
      FOREIGN KEY (\`seremiAnfitrion\`) REFERENCES \`seremis\`(\`id\`)
    );
    ...
    CREATE INDEX IF NOT EXISTS idx_visitas_aut_fecha ON visitas_autoridades(fecha);
    CREATE INDEX IF NOT EXISTS idx_visitas_aut_tipo  ON visitas_autoridades(tipoAutoridad);
  `);
